...
export class CustomizeItemComponent {
  ...
  onAddToCart(): void {
    this.cartService.addToCart(
      this.customizeItemService.product.getValue(),
      this.design,
      this.text
    );
